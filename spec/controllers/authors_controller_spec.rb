  ...
  describe "PUT #update" do
    context "successful update" do
      ...
      it "updates the modified author object" do
        put :update, author: Fabricate.attributes_for(:author, first_name: "Tawhid"), id: sajid.id
        expect(Author.last.first_name).to eq("Tawhid")
        expect(Author.last.first_name).not_to eq("Sajid")
      end
